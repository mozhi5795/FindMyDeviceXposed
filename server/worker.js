...
function getTileUrl(){var u=localStorage.getItem('fmd_tile_url');return u||'https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';}function getTileOpts(u){var o={attribution:'Map',maxZoom:19};if(u.indexOf('{s}')>=0){if(u.indexOf('webrd')>=0||u.indexOf('autonavi')>=0){o.subdomains=['0','1','2','3']}}return o}function initMap(){MAP=L.map('map',{center:[35,105],zoom:5,zoomControl:true});var u=getTileUrl();L.tileLayer(u,getTileOpts(u)).addTo(MAP);}
